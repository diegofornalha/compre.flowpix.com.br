...
import EthereumWidget from "@/components/ethereum-widget";
import { motion } from "framer-motion";
import Link from "next/link";

export default function ComprarEthereumPage() {
  return (
          ...
          >
            <section>
              <motion.h2 
                ...
                className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent mb-8"
              >
                Como funciona
              </motion.h2>
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">ESCOLHA A QUANTIDADE DE ETH</h3>
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">RECEBA SEUS ETH</h3>
            ...
            <motion.section 
              ...
              className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-8 shadow-xl relative overflow-hidden"
            >
              <motion.div 
              ...
              <div className="text-center relative z-10">
                ...
                <Link href="/flow">
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-white text-blue-600 font-semibold py-4 px-8 rounded-xl text-lg transition-all duration-300 w-full max-w-sm shadow-lg hover:shadow-xl relative overflow-hidden group"
                  >
                    <motion.span 
                      className="absolute inset-0 bg-gradient-to-r from-blue-400/10 to-blue-600/10"
                      initial={{ x: "-100%" }}
                      whileHover={{ x: "100%" }}
                      transition={{ duration: 0.5 }}
                    />
