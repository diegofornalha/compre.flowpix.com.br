...
export default function ComprarBitcoinPage() {
  return (
          ...
          >
            <section>
              <motion.h2 
                ...
                className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent mb-8"
              >
                Como funciona
              </motion.h2>
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">ESCOLHA A QUANTIDADE DE BTC</h3>
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">RECEBA SEUS BTC</h3>
                    <p className="text-gray-600">Seus bitcoins serão enviados diretamente para sua carteira.</p>
                  </div>
                </motion.div>
              </div>
            </section>
            ...
            <motion.section 
              ...
              className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 shadow-xl relative overflow-hidden"
            >
              <motion.div 
              ...
              <div className="text-center relative z-10">
                ...
                <Link href="/flow">
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-white text-orange-600 font-semibold py-4 px-8 rounded-xl text-lg transition-all duration-300 w-full max-w-sm shadow-lg hover:shadow-xl relative overflow-hidden group"
                  >
                    <motion.span 
                      className="absolute inset-0 bg-gradient-to-r from-orange-400/10 to-orange-600/10"
                      initial={{ x: "-100%" }}
                      whileHover={{ x: "100%" }}
                      transition={{ duration: 0.5 }}
                    />
