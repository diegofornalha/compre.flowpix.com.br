...
export default function UrzekeNFTPage(): ReactElement {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg relative">
                    ...
                    <h4 className="text-lg font-semibold mb-2">NFTs Exclusivos</h4>
                    <p className="text-gray-600">Colecionáveis únicos com benefícios especiais.</p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg relative">
                    ...
                    <p className="text-gray-600">NFTs verificados e autenticados.</p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg relative">
                    ...
                    <h4 className="text-lg font-semibold mb-2">Benefícios Exclusivos</h4>
                    <p className="text-gray-600">Acesso VIP a eventos e promoções.</p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg relative">
                    ...
                    <h4 className="text-lg font-semibold mb-2">Marketplace NFT</h4>
                    <p className="text-gray-600">Compre e venda NFTs com facilidade.</p>
                  </div>
                </div>
              </div>
            </motion.section>
                ...
                <motion.div variants={itemVariants}>
                  <div className="grid grid-cols-2 gap-4">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                    >
                      <span className="relative z-10">Comprar NFT</span>
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                    >
                      <span className="relative z-10">Vender NFT</span>
                  ...
                  <motion.div variants={itemVariants}>
                    <div className="relative">
                      ...
                      <div className="flex items-center gap-4 bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 relative">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-gray-900">NFTs com Cashback</h3>
                          <p className="text-gray-600">Ganhe tokens $BR ao comprar NFTs exclusivos.</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
